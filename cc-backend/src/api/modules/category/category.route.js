...
const { createCategory, getFeaturedCategories, updateCategory, getCategoryById, deleteCategory } = require("./category.controller")
...
router.delete("/delete/:id", bsonChecker, deleteCategory);
